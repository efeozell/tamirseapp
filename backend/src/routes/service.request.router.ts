...
router.post("/requests", authMiddleware.protectRoute, serviceRequestController.createRequest);
...
router.post("/requests/:id/rate", authMiddleware.protectRoute, serviceRequestController.rateRequestById);
